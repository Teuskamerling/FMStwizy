...
// configTICK_RATE_HZ is > 1000, which means that 0 < portTICK_PERIOD_MS < 1 (see
// the file portmacro.h). A non integer does not fit in the TickType_t datatype
// (uint32_t). For that reason, the period is defined in microseconds.
